...
public class AlertDialogRadio extends DialogFragment {
	 ...
	 * interface AlertPositiveListener and AlertNegativeListener
	 * */
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		b.setTitle(getResources().getString(R.string.text_gpsTracking));

		/** Setting a icon for the window */
		b.setIcon(android.R.drawable.ic_menu_mylocation);

		b.setCancelable(false);
		/** Setting items to the alert dialog */
		
		b.setSingleChoiceItems(
				getResources().getStringArray(R.array.trackingTiming),
				position, null);
